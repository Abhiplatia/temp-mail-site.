        ...
        {currentEmail && !loading && (
          <>
            ...
            <div className="flex justify-center my-8">
              <a 
                href="https://buymeacoffee.com/platiabrothers" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#FFDD00] hover:bg-[#FFDD00]/90 text-gray-900 font-medium px-6 py-3 rounded-lg transition-all hover:scale-105 shadow-md hover:shadow-lg"
